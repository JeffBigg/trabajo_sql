            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-dark-100">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#registrar-producto">
                        Registrar producto
                    </button>
                    ...
                    <form action="{{ route('producto.store') }}" method="POST">
                        @csrf
                        <div class="modal fade" id="registrar-producto" tabindex="-1"
                            aria-labelledby="registrar-producto-label" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/registrar-producto" method="post">
                                            <div class="mb-3">
                                                <label for="nombre-producto" class="form-label">Nombre del
                                                    producto</label>
